...
import '../models/prestamo_api_adapter.dart'; // ← usa toApiMap() y prestamoFromApiMap()

class ApiService {
  ApiService._();
  static final ApiService instance = ApiService._();

  // ⛳ Cambia por tu base real
  ...
  Future<int> crearPrestamo(Prestamo p) async {
    ...
    final resp = await http.post(
      ...
      body: jsonEncode(p.toApiMap()), // ← ADAPTER (no toMap)
    );
    ...
    if (resp.statusCode == 200) {
      ...
      final map = decoded is Map && decoded['data'] is Map
          ...
          : decoded is Map
              ...
              : <String, dynamic>{};
      return prestamoFromApiMap(map); // ← ADAPTER (no Prestamo.fromMap)
    }
